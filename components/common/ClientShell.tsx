...
function PremiumLoader() {
  return (
    <svg className="premium-loader" xmlns="http://www.w3.org/2000/svg" height={200} width={200} viewBox="0 0 200 200" aria-hidden="true">
      <g>
        <polygon className="loader-bounce" transform="rotate(45 100 100)" strokeWidth={1} stroke="#38bdf8" fill="none" points="70,70 148,50 130,130 50,150" />
        ...
        <polygon transform="translate(20, 31)" strokeWidth={2} stroke="none" fill="#38bdf8" points="80,50 80,75 80,99 40,75" />
        <polygon transform="translate(20, 31)" strokeWidth={2} stroke="none" fill="#38bdf8" opacity={0.28} points="40,-40 80,-40 80,99 40,75" />
        ...
        <polygon transform="rotate(0 100 100) translate(60, 20)" strokeWidth={2} stroke="none" fill="#38bdf8" opacity={0.28} points="40,-40 80,-40 80,85 40,110.2" />
        <polygon className="loader-particle" transform="rotate(45 100 100) translate(80, 95)" strokeWidth={2} stroke="none" fill="#38bdf8" points="5,0 5,5 0,5 0,0" />
