...
function PremiumLoader() {
  return (
    <svg className="premium-loader" xmlns="http://www.w3.org/2000/svg" height={200} width={200} viewBox="0 0 200 200" aria-hidden="true">
      <g>
        <polygon className="loader-bounce" transform="rotate(45 100 100)" strokeWidth={1} stroke="#f50057" fill="none" points="70,70 148,50 130,130 50,150" />
        ...
        <polygon transform="translate(20, 31)" strokeWidth={2} stroke="none" fill="#f50057" points="80,50 80,75 80,99 40,75" />
        ...
        <defs>
          <linearGradient y2="100%" x2="0%" y1="-17%" x1="10%" id="loader-gradiente-2">
            <stop style={{ stopColor: "#f5005700", stopOpacity: 1 }} offset="20%" />
            <stop className="loader-animated-stop" style={{ stopColor: "#f5005754", stopOpacity: 1 }} offset="100%" />
          </linearGradient>
        </defs>
        ...
        <polygon className="loader-particle" transform="rotate(45 100 100) translate(80, 95)" strokeWidth={2} stroke="none" fill="#f50057" points="5,0 5,5 0,5 0,0" />
